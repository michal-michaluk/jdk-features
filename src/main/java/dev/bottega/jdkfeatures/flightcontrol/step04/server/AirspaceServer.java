package dev.bottega.jdkfeatures.flightcontrol.step04.server;

import com.sun.net.httpserver.HttpExchange;
import com.sun.net.httpserver.HttpServer;
import dev.bottega.jdkfeatures.flightcontrol.step04.domain.Airspace;
import dev.bottega.jdkfeatures.flightcontrol.step04.domain.Area;
import dev.bottega.jdkfeatures.flightcontrol.step04.domain.Circle;
import dev.bottega.jdkfeatures.flightcontrol.step04.domain.Polygon;
...
/**
 * Thin HTTP <b>infrastructure</b> for the step-04 exercise (JEP 408 Simple Web Server).
 *
...
public final class AirspaceServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Flight Control step-04 server: http://localhost:" + server.port() + "/");
    }
}
